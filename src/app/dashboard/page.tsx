        ...
        <div className="space-y-4 animate-fade-in-up px-4 pt-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {stats.map((stat, i) => (
                    <div
                        key={stat.label}
                        className={`stat-card ${stat.cardClass} p-4 animate-fade-in-up`}
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-[11px] text-slate-400 mt-1 font-semibold uppercase tracking-wider">{stat.label}</p>
                        </div>
                    </div>
                ))}
            </div>
